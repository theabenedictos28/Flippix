...
<header class="bg-card-light dark:bg-card-dark shadow-md sticky top-0 z-50 transition-colors duration-300">
  <nav class="container mx-auto px-6 py-3 flex justify-between items-center">
    ...
    <div class="hidden md:flex items-center space-x-8">
      <a href="landingpage.php" class="text-primary font-semibold hover:text-blue-600">Home</a>
    ...
    <div class="hidden md:flex items-center space-x-4">
        ...
        <button class="bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary/90 transition-colors">Login</button>
        </a>
  ...
  <div id="mobile-menu" class="md:hidden hidden bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
    <div class="flex flex-col space-y-3 px-6 py-4">
      ...
      <a href="login.php" class="login-button">
        <button class="flex items-center bg-primary text-white w-full px-4 py-2 rounded-lg hover:bg-primary/90 transition-colors">Login</button>
        </a>
    </div>
  </div>
</header>
...
<h2 class="text-3xl md:text-4xl font-semibold text-primary mb-6">Flashcards</h2>
<p class="text-lg text-subtext-light dark:text-subtext-dark mb-8">
                        Take control of your learning journey by creating personalized flashcards that work perfectly for your unique study needs. When you make your own flashcards, you're not just preparing study materials — you're actively engaging with the content, which boosts retention and understanding.
                    </p>
<div class="flex justify-center md:justify-start space-x-4">
<a class="bg-primary text-white px-8 py-3 rounded-lg font-semibold text-lg hover:bg-primary/90 transition-colors shadow-lg" href="signup.php">Signup</a>
<a class="bg-gray-200 dark:bg-gray-700 text-text-light dark:text-text-dark px-8 py-3 rounded-lg font-semibold text-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors" href="howto.html">How To Use</a>
</div>
</div>
<div class="md:w-1/2 lg:w-3/5 mt-12 mx-10 container md:mt-0 md:pl-12">
<img alt="Flashcards illustration" class="w-96 h-auto rounded-lg" src="images/labers.png"/>
</div>
</section>
</main>
