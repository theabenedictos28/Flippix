...
<header class="bg-card-light dark:bg-card-dark shadow-md sticky top-0 z-50 transition-colors duration-300">
  ...
  <main class="flex-grow flex items-center justify-center px-4 py-12">
    <form method="POST" class="bg-card-light dark:bg-card-dark shadow-md p-8 rounded-2xl w-full max-w-sm text-center">
      <h2 class="text-2xl font-bold text-text-light dark:text-text-dark mb-6">Create an Account</h2>

      <input type="text" name="username" placeholder="Username" required
        class="block w-full mb-4 p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary focus:border-primary transition">
      ...
      <input type="password" name="confirm_password" placeholder="Confirm Password" required
        class="block w-full mb-6 p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary focus:border-primary transition">

      <button type="submit"
        class="bg-primary text-white w-full py-3 rounded-lg hover:bg-primary/90 transition-colors font-semibold">
        Sign Up
      </button>

      <p class="mt-4 text-sm text-subtext-light dark:text-subtext-dark">
  ...
  <footer class="bg-card-light dark:bg-card-dark mt-auto">
    <div class="container mx-auto px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex justify-center items-center">
      <img src="images/labers.png" alt="Flippix small logo" class="h-6 w-6 mr-2">
